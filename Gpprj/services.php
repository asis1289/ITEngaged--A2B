    ...
    <section class="container">
        ...
        <div class="grid-3">
            <div class="card">
                ...
                <p>Professional planning for meetings, conferences, and corporate gatherings.</p>
            </div>
            <div class="card">
                <img src="images/wedding.jpg" alt="Weddings">
                <h3>Weddings</h3>
                <p>Beautiful wedding planning and coordination for your special day.</p>
            </div>
            <div class="card">
                <img src="images/concert.jpg" alt="Concerts">
                <h3>Concerts</h3>
                <p>Amazing concert experiences with top artists and performers.</p>
            </div>
            <div class="card">
                <img src="images/birthday.jpg" alt="Birthdays">
                <h3>Birthdays</h3>
                <p>Memorable birthday celebrations tailored to all ages.</p>
            </div>
            <div class="card">
                <img src="images/exhibition.jpg" alt="Exhibitions">
                <h3>Exhibitions</h3>
                <p>Showcase your products and services at our professional exhibitions.</p>
            </div>
        </div>
    </section>
